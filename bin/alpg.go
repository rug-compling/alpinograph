...
var (
	...
	reAny    = regexp.MustCompile(`[a-zA-Z]+\[[0-9]+\.[0-9]+\](\[[0-9]+\.[0-9]+,[0-9]+\.[0-9]+\])?{.*?}`)
	reEdge   = regexp.MustCompile(`^[a-zA-Z]+\[[0-9]+\.[0-9]+\]\[[0-9]+\.[0-9]+,[0-9]+\.[0-9]+\]{.*}$`)
	reVertex = regexp.MustCompile(`^[a-zA-Z]+\[[0-9]+\.[0-9]+\]{.*}$`)
